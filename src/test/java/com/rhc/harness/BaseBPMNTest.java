...
/**
 * This class constructs a ksession for the given test resources (bpmn2 classpath resources)
 * for use in each BPMN test case.
 * 
 * @author jcohler
 * 
 */
public class BaseBPMNTest extends JbpmJUnitBaseTestCase {
	...
	/**
	 * This method is run before each individual BPMN test to set a new knowledge session
	 * with the resources required for the test to run successfully.
	 * 
	 */
	@Before
	...
	/**
	 * This method loops through the ksession for outstanding work items with the given 
	 * name and completes the work item with the given data outputs.
	 * 
	 * @param itemName
	 * @param itemOutput
	 */
	...
	/**
	 * This method sets this base class with the resource names to be injected in
	 * the ksession for each individual test.
	 * 
	 * @param resources
	 */
